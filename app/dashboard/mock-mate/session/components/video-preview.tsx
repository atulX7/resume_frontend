  ...
  return (
    <Card className="flex-1 min-h-0 dark:bg-gray-800 dark:border-gray-700">
      <CardContent className="p-4 h-full">
        <div className="relative h-full bg-gray-900 dark:bg-gray-900 rounded-lg overflow-hidden">
          <video
            ref={videoRef}
            autoPlay
            muted
          ...
          <div className="absolute bottom-4 left-4 flex items-center gap-4">
            <div className="flex items-center gap-2 bg-black/50 dark:bg-black/70 text-white px-3 py-1 rounded-full">

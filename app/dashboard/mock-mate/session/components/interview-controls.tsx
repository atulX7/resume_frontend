...
export function InterviewControls({
  ...
  return (
    <Card className="flex-none dark:bg-gray-800 dark:border-gray-700">
      <CardContent className="p-6">
        {isAllQuestionsAnswered ? (
          <Button
            ...
            variant="default"
            size="lg"
            className="w-full h-12 text-base gap-2 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white"
          >
          ...
          <Button
            ...
            variant="destructive"
            size="lg"
            className="w-full h-12 text-base gap-2 bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 text-white"
          >
